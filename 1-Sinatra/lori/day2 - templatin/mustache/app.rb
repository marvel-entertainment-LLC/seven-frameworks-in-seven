...
get "/bookmarks/:id" do
  id = params[:id] #gets param id passed in
  @bookmark = Bookmark.get(id) # queries for said id 
  #respond_with :bookmark_form_edit, @bookmark #return with template and passed data
